...
public class ManyDaysPickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarView.setOnForwardPageChangeListener(() ->
                Toast.makeText(ManyDaysPickerActivity.this, "Forward", Toast.LENGTH_SHORT).show());

        calendarView.setOnPreviousPageChangeListener(() ->
                Toast.makeText(ManyDaysPickerActivity.this, "Previous", Toast.LENGTH_SHORT).show());
...
//        calendarView.setEvents(events);
        ...
        getDateButton.setOnClickListener(v -> {
            for (Calendar calendar : calendarView.getSelectedDates()) {
                ...
                Toast.makeText(ManyDaysPickerActivity.this,
