...
public class DatePicker {
    ...
    public DatePicker show() {
        ...
        final View view = layoutInflater.inflate(com.app.custcalendar.R.layout.date_picker_dialog, null);

        if(mCalendarProperties.getPagesColor() != 0){
            view.setBackgroundColor(mCalendarProperties.getPagesColor());
        }

        mCancelButton = (AppCompatButton) view.findViewById(com.app.custcalendar.R.id.negative_button);
        mOkButton = (AppCompatButton) view.findViewById(com.app.custcalendar.R.id.positive_button);
        mTodayButton = (AppCompatButton) view.findViewById(com.app.custcalendar.R.id.today_button);
        ...
        FrameLayout calendarContainer = (FrameLayout) view.findViewById(com.app.custcalendar.R.id.calendarContainer);
    ...
    private void setOkButtonState(boolean enabled) {
        ...
        if (mCalendarProperties.getDialogButtonsColor() != 0) {
            mOkButton.setTextColor(ContextCompat.getColor(mContext, enabled
                    ? mCalendarProperties.getDialogButtonsColor() : com.app.custcalendar.R.color.disabledDialogButtonColor));
        }
    }
