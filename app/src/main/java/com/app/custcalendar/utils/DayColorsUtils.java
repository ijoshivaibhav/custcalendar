...
public class DayColorsUtils {
     ...
     */
    public static void setDayColors(TextView textView, int textColor, int typeface, int background, String type) {
        if (textView == null) {
            return;
        }
    ...
    public static void setSelectedDayColors(TextView dayLabel, CalendarProperties calendarProperties) {
        setDayColors(dayLabel, calendarProperties.getSelectionLabelColor(), Typeface.NORMAL,
                com.app.custcalendar.R.drawable.background_color_circle_selector, "select");

        dayLabel.getBackground().setColorFilter(calendarProperties.getSelectionColor(),
                android.graphics.PorterDuff.Mode.MULTIPLY);
    }

    public static void setBookedDayColors(TextView dayLabel, CalendarProperties calendarProperties) {
        setDayColors(dayLabel, calendarProperties.getBookedDaysLabelsColor(), Typeface.NORMAL,
                R.drawable.background_red, "booked");

        dayLabel.getBackground().setColorFilter(calendarProperties.getDisabledDaysColor(),
                android.graphics.PorterDuff.Mode.MULTIPLY);
    }
    ...
    public static void setCurrentMonthDayColors(Calendar day, Calendar today, TextView dayLabel,
        ...
        if (today.equals(day)) {
            setDayColors(dayLabel, calendarProperties.getTodayLabelColor(), Typeface.BOLD,
                    com.app.custcalendar.R.drawable.background_green, "default");
        } else {
            setDayColors(dayLabel, calendarProperties.getDaysLabelsColor(), Typeface.NORMAL,
                    R.drawable.background_green, "default");
        }
    }
}
