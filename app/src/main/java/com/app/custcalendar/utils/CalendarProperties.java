...
import com.app.custcalendar.exceptions.UnsupportedMethodsException;
...
import com.app.custcalendar.listeners.OnSelectionAbilityListener;
...
public class CalendarProperties {
    ...
    private int mCalendarType, mHeaderColor, mHeaderLabelColor, mSelectionColor, mTodayLabelColor,
            mDialogButtonsColor, mItemLayoutResource, mDisabledDaysLabelsColor, mBookedDaysLabelsColor, mPagesColor,
    ...
    private List<Calendar> mBookedDays = new ArrayList<>();
    ...
    public int getSelectionColor() {
        if (mSelectionColor == 0) {
            return ContextCompat.getColor(mContext, com.app.custcalendar.R.color.defaultColor);
        }
    ...
    public void setDisabledColor(int selectionColor) {
        mSelectionColor = selectionColor;
    }
    ...
    public List<Calendar> getBookedDays() {
        return mBookedDays;
    }

    public void setBookedDays(List<Calendar> bookedDays) {
        mSelectedDays.removeAll(bookedDays);

        mBookedDays = Stream.of(bookedDays)
                .map(calendar -> {
                    DateUtils.setMidnight(calendar);
                    return calendar;
                }).toList();
    ...
    public void setSelectedDays(List<Calendar> selectedDays) {
        ...
        mSelectedDays = Stream.of(selectedDays)
                ...
                }).filterNot(value -> mDisabledDays.contains(value.getCalendar())).filterNot(value -> mBookedDays.contains(value.getCalendar()))
                .toList();
    }
    ...
    public int getDisabledDaysLabelsColor() {
        if (mDisabledDaysLabelsColor == 0) {
            return ContextCompat.getColor(mContext, com.app.custcalendar.R.color.nextMonthDayColor);
        }
    ...
    public int getBookedDaysLabelsColor() {
        if (mBookedDaysLabelsColor == 0) {
            return ContextCompat.getColor(mContext, com.app.custcalendar.R.color.nextMonthDayColor);
        }

        return mBookedDaysLabelsColor;
    }

    public void setBookedDaysLabelsColor(int bookedDaysLabelsColor) {
        mBookedDaysLabelsColor = bookedDaysLabelsColor;
    }
    ...
    public int getDaysLabelsColor() {
        if (mDaysLabelsColor == 0) {
            return ContextCompat.getColor(mContext, com.app.custcalendar.R.color.currentMonthDayColor);
        }
