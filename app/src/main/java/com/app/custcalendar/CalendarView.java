...
import com.app.custcalendar.exceptions.ErrorsMessages;
import com.app.custcalendar.exceptions.OutOfDateRangeException;
import com.app.custcalendar.extensions.CalendarViewPager;
import com.app.custcalendar.listeners.OnCalendarPageChangeListener;
import com.app.custcalendar.listeners.OnDayClickListener;
import com.app.custcalendar.utils.AppearanceUtils;
...
import static com.app.custcalendar.utils.CalendarProperties.FIRST_VISIBLE_PAGE;
...
public class CalendarView extends LinearLayout {
    ...
    protected CalendarView(Context context, CalendarProperties calendarProperties) {
        ...
        inflater.inflate(com.app.custcalendar.R.layout.calendar_view, this);
    ...
    private void setAttributes(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.app.custcalendar.R.styleable.CalendarView);
    ...
    private void initCalendarProperties(TypedArray typedArray) {
        int headerColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_headerColor, 0);
        mCalendarProperties.setHeaderColor(headerColor);

        int headerLabelColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_headerLabelColor, 0);
        mCalendarProperties.setHeaderLabelColor(headerLabelColor);

        int abbreviationsBarColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_abbreviationsBarColor, 0);
        mCalendarProperties.setAbbreviationsBarColor(abbreviationsBarColor);

        int abbreviationsLabelsColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_abbreviationsLabelsColor, 0);
        mCalendarProperties.setAbbreviationsLabelsColor(abbreviationsLabelsColor);

        int pagesColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_pagesColor, 0);
        mCalendarProperties.setPagesColor(pagesColor);

        int daysLabelsColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_daysLabelsColor, 0);
        mCalendarProperties.setDaysLabelsColor(daysLabelsColor);

        int anotherMonthsDaysLabelsColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_anotherMonthsDaysLabelsColor, 0);
        mCalendarProperties.setAnotherMonthsDaysLabelsColor(anotherMonthsDaysLabelsColor);

        int todayLabelColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_todayLabelColor, 0);
        mCalendarProperties.setTodayLabelColor(todayLabelColor);

        int selectionColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_selectionColor, 0);
        mCalendarProperties.setSelectionColor(selectionColor);

        int selectionLabelColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_selectionLabelColor, 0);
        mCalendarProperties.setSelectionLabelColor(selectionLabelColor);

        int disabledDaysLabelsColor = typedArray.getColor(com.app.custcalendar.R.styleable.CalendarView_disabledDaysLabelsColor, 0);
        mCalendarProperties.setDisabledDaysLabelsColor(disabledDaysLabelsColor);

        int calendarType = typedArray.getInt(com.app.custcalendar.R.styleable.CalendarView_type, CLASSIC);
        mCalendarProperties.setCalendarType(calendarType);

        // Set picker mode !DEPRECATED!
        if (typedArray.getBoolean(com.app.custcalendar.R.styleable.CalendarView_datePicker, false)) {
            mCalendarProperties.setCalendarType(ONE_DAY_PICKER);
        }

        boolean eventsEnabled = typedArray.getBoolean(com.app.custcalendar.R.styleable.CalendarView_eventsEnabled,
                mCalendarProperties.getCalendarType() == CLASSIC);
        mCalendarProperties.setEventsEnabled(eventsEnabled);

        boolean swipeEnabled = typedArray.getBoolean(com.app.custcalendar.R.styleable.CalendarView_swipeEnabled, true);
        mCalendarProperties.setSwipeEnabled(swipeEnabled);

        Drawable previousButtonSrc = typedArray.getDrawable(com.app.custcalendar.R.styleable.CalendarView_previousButtonSrc);
        mCalendarProperties.setPreviousButtonSrc(previousButtonSrc);

        Drawable forwardButtonSrc = typedArray.getDrawable(com.app.custcalendar.R.styleable.CalendarView_forwardButtonSrc);
    ...
    private void setCalendarRowLayout() {
        if (mCalendarProperties.getEventsEnabled()) {
            mCalendarProperties.setItemLayoutResource(com.app.custcalendar.R.layout.calendar_view_day);
        } else {
            mCalendarProperties.setItemLayoutResource(com.app.custcalendar.R.layout.calendar_view_picker_day);
        }
    }

    private void initUiElements() {
        ImageButton forwardButton = (ImageButton) findViewById(com.app.custcalendar.R.id.forwardButton);
        forwardButton.setOnClickListener(onNextClickListener);

        ImageButton previousButton = (ImageButton) findViewById(com.app.custcalendar.R.id.previousButton);
        previousButton.setOnClickListener(onPreviousClickListener);

        mCurrentMonthLabel = (TextView) findViewById(com.app.custcalendar.R.id.currentDateLabel);

        mViewPager = (CalendarViewPager) findViewById(com.app.custcalendar.R.id.calendarViewPager);
    }
    ...
    public void setBookedDays(List<Calendar> bookedDays) {
        mCalendarProperties.setBookedDays(bookedDays);
    }
